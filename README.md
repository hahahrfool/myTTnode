...
【1-17】早七点，收集165星愿。不错。然而从昨天下午四点到现在为止，流量匀速下降，现在已经回到了2Mbps。如果流量不回升，估计今天又要凉。下午，发现流量果然一直颓废。因为在做一些其他操作，就重启了一下虚拟机。竟然发现uid又变化了。主要我缓存已经6G多了，之前本来总结的3G以上是不会变的。这下又打破了经验。

这次我做的变化是将ubuntu虚拟机的网卡开启混淆模式。但是发现似乎开启了之后，甜糖似乎无法被识别了？甜糖客户端一直在“信息获取中”
